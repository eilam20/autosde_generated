...
# Unit tests for EilamTest::HostClusterCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::HostClusterCreate do
  let(:instance) { EilamTest::HostClusterCreate.new }

  describe 'test an instance of HostClusterCreate' do
    it 'should create an instance of HostClusterCreate' do
      expect(instance).to be_instance_of(EilamTest::HostClusterCreate)
    end
  end
