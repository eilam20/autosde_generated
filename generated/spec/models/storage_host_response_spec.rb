...
# Unit tests for EilamTest::StorageHostResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::StorageHostResponse do
  let(:instance) { EilamTest::StorageHostResponse.new }

  describe 'test an instance of StorageHostResponse' do
    it 'should create an instance of StorageHostResponse' do
      expect(instance).to be_instance_of(EilamTest::StorageHostResponse)
    end
  end
