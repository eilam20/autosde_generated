...
# Unit tests for EilamTest::StorageHostCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::StorageHostCreate do
  let(:instance) { EilamTest::StorageHostCreate.new }

  describe 'test an instance of StorageHostCreate' do
    it 'should create an instance of StorageHostCreate' do
      expect(instance).to be_instance_of(EilamTest::StorageHostCreate)
    end
  end
