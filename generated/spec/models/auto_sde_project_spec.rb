...
# Unit tests for EilamTest::AutoSDEProject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::AutoSDEProject do
  let(:instance) { EilamTest::AutoSDEProject.new }

  describe 'test an instance of AutoSDEProject' do
    it 'should create an instance of AutoSDEProject' do
      expect(instance).to be_instance_of(EilamTest::AutoSDEProject)
    end
  end
