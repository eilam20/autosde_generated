...
# Unit tests for EilamTest::StorageHostUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::StorageHostUpdate do
  let(:instance) { EilamTest::StorageHostUpdate.new }

  describe 'test an instance of StorageHostUpdate' do
    it 'should create an instance of StorageHostUpdate' do
      expect(instance).to be_instance_of(EilamTest::StorageHostUpdate)
    end
  end
