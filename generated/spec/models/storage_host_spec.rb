...
# Unit tests for EilamTest::StorageHost
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::StorageHost do
  let(:instance) { EilamTest::StorageHost.new }

  describe 'test an instance of StorageHost' do
    it 'should create an instance of StorageHost' do
      expect(instance).to be_instance_of(EilamTest::StorageHost)
    end
  end
