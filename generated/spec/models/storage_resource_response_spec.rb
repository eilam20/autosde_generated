...
# Unit tests for EilamTest::StorageResourceResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::StorageResourceResponse do
  let(:instance) { EilamTest::StorageResourceResponse.new }

  describe 'test an instance of StorageResourceResponse' do
    it 'should create an instance of StorageResourceResponse' do
      expect(instance).to be_instance_of(EilamTest::StorageResourceResponse)
    end
  end
