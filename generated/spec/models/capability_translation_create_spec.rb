...
# Unit tests for EilamTest::CapabilityTranslationCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::CapabilityTranslationCreate do
  let(:instance) { EilamTest::CapabilityTranslationCreate.new }
  ...
  describe 'test an instance of CapabilityTranslationCreate' do
    it 'should create an instance of CapabilityTranslationCreate' do
      expect(instance).to be_instance_of(EilamTest::CapabilityTranslationCreate)
    end
  end
