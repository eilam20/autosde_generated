...
# Unit tests for EilamTest::StorageHostVolumeMappingCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::StorageHostVolumeMappingCreate do
  let(:instance) { EilamTest::StorageHostVolumeMappingCreate.new }
  ...
  describe 'test an instance of StorageHostVolumeMappingCreate' do
    it 'should create an instance of StorageHostVolumeMappingCreate' do
      expect(instance).to be_instance_of(EilamTest::StorageHostVolumeMappingCreate)
    end
  end
