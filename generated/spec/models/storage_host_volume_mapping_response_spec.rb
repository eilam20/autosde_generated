...
# Unit tests for EilamTest::StorageHostVolumeMappingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::StorageHostVolumeMappingResponse do
  let(:instance) { EilamTest::StorageHostVolumeMappingResponse.new }
  ...
  describe 'test an instance of StorageHostVolumeMappingResponse' do
    it 'should create an instance of StorageHostVolumeMappingResponse' do
      expect(instance).to be_instance_of(EilamTest::StorageHostVolumeMappingResponse)
    end
  end
