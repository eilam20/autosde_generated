...
# Unit tests for EilamTest::Snapshot
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::Snapshot do
  let(:instance) { EilamTest::Snapshot.new }

  describe 'test an instance of Snapshot' do
    it 'should create an instance of Snapshot' do
      expect(instance).to be_instance_of(EilamTest::Snapshot)
    end
  end
