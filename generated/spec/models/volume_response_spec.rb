...
# Unit tests for EilamTest::VolumeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::VolumeResponse do
  let(:instance) { EilamTest::VolumeResponse.new }

  describe 'test an instance of VolumeResponse' do
    it 'should create an instance of VolumeResponse' do
      expect(instance).to be_instance_of(EilamTest::VolumeResponse)
    end
  end
