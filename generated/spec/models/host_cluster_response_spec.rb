...
# Unit tests for EilamTest::HostClusterResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::HostClusterResponse do
  let(:instance) { EilamTest::HostClusterResponse.new }

  describe 'test an instance of HostClusterResponse' do
    it 'should create an instance of HostClusterResponse' do
      expect(instance).to be_instance_of(EilamTest::HostClusterResponse)
    end
  end
