...
# Unit tests for EilamTest::ServiceResourceAttachment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::ServiceResourceAttachment do
  let(:instance) { EilamTest::ServiceResourceAttachment.new }

  describe 'test an instance of ServiceResourceAttachment' do
    it 'should create an instance of ServiceResourceAttachment' do
      expect(instance).to be_instance_of(EilamTest::ServiceResourceAttachment)
    end
  end
