...
# Unit tests for EilamTest::CapabilityTranslation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::CapabilityTranslation do
  let(:instance) { EilamTest::CapabilityTranslation.new }

  describe 'test an instance of CapabilityTranslation' do
    it 'should create an instance of CapabilityTranslation' do
      expect(instance).to be_instance_of(EilamTest::CapabilityTranslation)
    end
  end
