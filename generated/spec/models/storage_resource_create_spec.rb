...
# Unit tests for EilamTest::StorageResourceCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::StorageResourceCreate do
  let(:instance) { EilamTest::StorageResourceCreate.new }

  describe 'test an instance of StorageResourceCreate' do
    it 'should create an instance of StorageResourceCreate' do
      expect(instance).to be_instance_of(EilamTest::StorageResourceCreate)
    end
  end
