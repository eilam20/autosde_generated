...
# Unit tests for EilamTest::ServiceCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::ServiceCreate do
  let(:instance) { EilamTest::ServiceCreate.new }

  describe 'test an instance of ServiceCreate' do
    it 'should create an instance of ServiceCreate' do
      expect(instance).to be_instance_of(EilamTest::ServiceCreate)
    end
  end
