...
# Unit tests for EilamTest::SnapshotCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::SnapshotCreate do
  let(:instance) { EilamTest::SnapshotCreate.new }

  describe 'test an instance of SnapshotCreate' do
    it 'should create an instance of SnapshotCreate' do
      expect(instance).to be_instance_of(EilamTest::SnapshotCreate)
    end
  end
