...
# Unit tests for EilamTest::HostClusterMembership
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe EilamTest::HostClusterMembership do
  let(:instance) { EilamTest::HostClusterMembership.new }

  describe 'test an instance of HostClusterMembership' do
    it 'should create an instance of HostClusterMembership' do
      expect(instance).to be_instance_of(EilamTest::HostClusterMembership)
    end
  end
